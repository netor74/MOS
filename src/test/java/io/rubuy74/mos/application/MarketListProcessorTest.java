...
class MarketListProcessorTest {
    ...
    void list_returnsEventsFromService() {
        ...
        List<Event> events = List.of(
                new Event("e1", "Event 1", LocalDate.parse("2025-10-06").atStartOfDay(ZoneOffset.UTC).toInstant().toEpochMilli()),
                new Event("e2", "Event 2", LocalDate.parse("2025-10-06").atStartOfDay(ZoneOffset.UTC).toInstant().toEpochMilli())
        );
